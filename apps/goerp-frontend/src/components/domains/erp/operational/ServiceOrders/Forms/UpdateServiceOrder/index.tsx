      ...
      .then(async (activeVehicles) => {
        ...
        await finishServiceOrder()
          ...
          .then(() => {
            ...
            serviceOrderActivitiesRefetch()
            setActiveEdit(false)
            notification('Ordem de serviço finalizada com sucesso', 'success')
          })
          .catch((err) => {
            showError(err)
          })
  ...
  async function initializeServiceOrdersSubmit() {
    await initializeServiceOrders({
      ...
      .then(() => {
        serviceOrderRefetch()
        setActiveEdit(false)
        notification('Serviços iniciados com sucesso', 'success')
      })
      .catch((err) => {
        showError(err)
      })
  ...
  async function concludeServiceOrdersSubmit() {
    await concludeServiceOrder({
      ...
      .then(() => {
        serviceOrderRefetch()
        setActiveEdit(false)
        notification('Serviços concluidos com sucesso', 'success')
      })
      .catch((err) => {
        showError(err)
      })
