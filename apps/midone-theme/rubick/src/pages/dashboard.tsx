      ...
      <nav className={styles['side-nav']}>
        ...
        <ul>
          <li>
            <a
              href="/teste"
              className={styles['side-menu'] + ' ' + styles['side-active']}
            >
              ...
              <div className={styles['side-menu__title']}>
                Dashboard
                <div
                  className={`transform rotate-180 ${styles['side-menu__sub-icon']}`}
                >
          ...
          <li>
            <a href="javascript:;" className={styles['side-menu']}>
              ...
              <div className={styles['side-menu__title']}>
                Menu Layout
                <div className={styles['side-menu__sub-icon']}>
                  <i data-feather="chevron-down" />
                </div>
              </div>
            </a>
      ...
      <div className="content">
        <div className="top-bar">
          <div className="hidden mr-auto -intro-x breadcrumb sm:flex">
            ...
            <i data-feather="chevron-right" className="breadcrumb__icon" />{' '}
          ...
          <div className="relative mr-3 intro-x sm:mr-6">
            <div className="hidden search sm:block">
              <input
                type="text"
                className="border-transparent search__input form-control placeholder-theme-13"
                placeholder="Search..."
              />
              <i
                data-feather="search"
              ...
              <div className="search-result__content">
                ...
                <div className="mb-5">
                  <a href="" className="flex items-center">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-theme-18 text-theme-9">
                  ...
                  <a href="" className="flex items-center mt-2">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-theme-14 text-theme-10">
                      <i className="w-4 h-4" data-feather="credit-card" />
                    </div>
                ...
                <div className="mb-5">
                  <a href="" className="flex items-center mt-2">
                    ...
                    <div className="w-48 ml-auto text-xs text-right text-gray-600 truncate">
          ...
          <div className="mr-auto intro-x dropdown sm:mr-6">
            <div
              className="cursor-pointer dropdown-toggle notification notification--bullet"
              role="button"
              aria-expanded="false"
            >
              <i
                ...
                <div className="relative flex items-center cursor-pointer">
                  <div className="flex-none w-12 h-12 mr-1 image-fit">
                    <img
                      ...
                      src="/dist/images/profile-10.jpg"
                    />
                    <div className="absolute bottom-0 right-0 w-3 h-3 border-2 border-white rounded-full bg-theme-9" />
                  </div>
          ...
          <div className="w-8 h-8 intro-x dropdown">
            <div
              className="w-8 h-8 overflow-hidden rounded-full shadow-lg dropdown-toggle image-fit zoom-in"
              role="button"
              aria-expanded="false"
            >
              <img
              ...
              <div className="text-white dropdown-menu__content box bg-theme-26 dark:bg-dark-6">
                ...
                <div className="p-2">
                  ...
                  <a
                    ...
                    className="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"
                  >
                    <i data-feather="edit" className="w-4 h-4 mr-2" /> Add
                    Account{' '}
                  </a>
                  <a
                    href=""
                  ...
                  <a
                    ...
                    className="flex items-center block p-2 transition duration-300 ease-in-out rounded-md hover:bg-theme-1 dark:hover:bg-dark-3"
                  >
                    <i data-feather="help-circle" className="w-4 h-4 mr-2" />{' '}
                    Help{' '}
                  </a>
                </div>
          ...
          <div className="col-span-12 2xl:col-span-9">
            <div className="grid grid-cols-12 gap-6">
              <div className="col-span-12 mt-6 -mb-6 intro-y">
                <div
                  className="flex items-center mb-6 text-white alert alert-dismissible show box bg-theme-3"
                  role="alert"
                >
                  <span>
                  ...
                  <div className="box sm:flex">
                    <div className="flex flex-col justify-center flex-1 px-8 py-12">
                      <i
                        ...
                        className="w-10 h-10 text-theme-12"
                      />
                      ...
                      <div
                        className="cursor-pointer report-box-2__indicator bg-theme-9 tooltip"
                      ...
                      <button className="relative justify-start mt-12 rounded-full btn btn-outline-secondary">
                        Download Reports
                        <span className="w-8 h-8 absolute flex justify-center items-center bg-theme-1 text-white rounded-full right-0 top-0 bottom-0 my-auto ml-auto mr-0.5">
                          {' '}
                          <i
                    ...
                    <div className="flex flex-col justify-center flex-1 px-8 py-12 border-t border-gray-300 border-dashed sm:border-t-0 sm:border-l dark:border-dark-5">
                      ...
                      <div className="mt-1.5 flex items-center">
                        ...
                        <div
                          className="flex ml-2 text-xs font-medium cursor-pointer text-theme-6 tooltip"
                      ...
                      <div className="mt-5 text-xs text-gray-600 dark:text-gray-600">
                        CANCELATION CASE
                      </div>
                      <div className="mt-1.5 flex items-center">
                      ...
                      <div className="mt-1.5 flex items-center">
                        ...
                        <div
                          className="flex ml-2 text-xs font-medium cursor-pointer text-theme-9 tooltip"
              ...
              <div className="col-span-12 mt-2 sm:col-span-6 lg:col-span-4 xl:col-span-3">
                <div className="flex items-center h-10 intro-y">
                  ...
                  <a
                    href=""
                    className="ml-auto truncate text-theme-1 dark:text-theme-10"
                  >
                    View on Map
                  </a>
                </div>
                  ...
                  <div className="p-5 box">
                    <div className="flex items-center">
                      ...
                      <div className="ml-auto dropdown">
                        <a
                          className="block w-5 h-5 -mr-2 dropdown-toggle"
                          href="javascript:;"
                          aria-expanded="false"
                        >
                          <i
                    ...
                    <div className="flex pb-2 mt-4 border-b border-gray-200">
                      ...
                      <div
                        className="flex ml-auto text-xs font-medium cursor-pointer text-theme-9 tooltip"
                    ...
                    <div className="flex pb-2 mt-4 mb-2 text-xs text-gray-600 border-b border-gray-200 dark:text-gray-600">
                    ...
                    <button className="w-full px-2 py-1 mt-4 border-dashed btn btn-outline-secondary">
                      Real-Time Report
                    </button>
                  </div>
                </div>
                      ...
                      >
                        <div className="relative">
                          ...
                          <div className="absolute top-0 left-0 flex flex-col items-center justify-center w-full h-full">
                            ...
                            <div className="text-gray-600 dark:text-gray-600 mt-0.5">
                              Active Users
                            </div>
                          </div>
                        </div>
                        <div className="mt-5">
                          <div className="flex items-center">
                            ...
                            <div className="flex-1 h-px mx-3 border border-r border-gray-300 border-dashed xl:hidden" />
              ...
              <div className="col-span-12 mt-6 lg:col-span-8">
                <div className="items-center block h-10 intro-y sm:flex">
                  ...
                  <div className="relative mt-3 text-gray-700 sm:ml-auto sm:mt-0 dark:text-gray-300">
                    ...
                    <input
                      type="text"
                      className="pl-10 form-control sm:w-40 box"
                ...
                <div className="p-5 mt-12 intro-y box sm:mt-5">
                  ...
                  <div
                    className="mt-5 bg-gray-200 rounded-md report-maps"
                ...
                <div className="mt-5">
                  <div className="intro-y">
                    <div className="flex items-center px-4 py-4 mb-3 box zoom-in">
                      ...
                      <div className="px-2 py-1 text-xs font-medium text-white rounded-full cursor-pointer bg-theme-9">
                        137 Sales
                      </div>
                    </div>
                  </div>
                  ...
                  <a
                    href=""
                    className="block w-full py-4 text-center border border-dotted rounded-md intro-y border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600"
                  >
                    View More
                  </a>
                </div>
              ...
              <div className="col-span-12 mt-6 lg:col-span-6">
                <div className="relative p-8 overflow-hidden ads-box box bg-theme-3 intro-y">
                  <div className="w-full -mt-3 text-xl text-white ads-box__title sm:w-72">
                    Transact safely with Lender’s Fund Account (RDL)
                  </div>
                  <div className="w-full mt-3 leading-relaxed text-white sm:w-72 text-opacity-70 dark:text-gray-600 dark:text-opacity-100">
                    Apply now, quick registration
                  </div>
                  <button className="w-32 mt-6 bg-white btn dark:bg-dark-2 dark:text-white sm:mt-10">
                    Start Now
                  </button>
                  <img
              ...
              <div className="col-span-12 mt-6 lg:col-span-6">
                <div className="relative p-8 overflow-hidden ads-box box intro-y">
                  <div className="w-full -mt-3 text-xl ads-box__title sm:w-52 text-theme-1 dark:text-white">
                    Invite friends to get{' '}
                    <span className="font-medium">FREE</span> bonuses!
                  </div>
                  <div className="w-full mt-2 leading-relaxed text-gray-600 sm:w-60">
                    Get a IDR 100,000 voucher by inviting your friends to fund
                    #BecomeMember
                  </div>
                  <div
                    className="relative w-48 mt-6 cursor-pointer tooltip"
              ...
              <div className="col-span-12 mt-6">
                <div className="items-center block h-10 intro-y sm:flex">
                  ...
                  <div className="flex items-center mt-3 sm:ml-auto sm:mt-0">
                    <button className="flex items-center text-gray-700 btn box dark:text-gray-300">
                      <i
                        data-feather="file-text"
                    ...
                    <button className="flex items-center ml-3 text-gray-700 btn box dark:text-gray-300">
                      <i
                        data-feather="file-text"
                        className="hidden w-4 h-4 mr-2 sm:block"
                      />{' '}
                          ...
                          <div className="flex">
                            <div className="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                title="Uploaded at 13 August 2020"
                              />
                            </div>
                          ...
                          <div className="flex">
                            <div className="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                className="rounded-full tooltip"
                                src="/dist/images/preview-6.jpg"
                                title="Uploaded at 13 December 2022"
                              />
                            </div>
                            <div className="w-10 h-10 -ml-5 image-fit zoom-in">
                              <img
                                ...
                                title="Uploaded at 3 September 2020"
                              />
                            </div>
                            <div className="w-10 h-10 -ml-5 image-fit zoom-in">
                              <img
                          ...
                          <div className="flex">
                            <div className="w-10 h-10 image-fit zoom-in">
                              <img
                                ...
                                className="rounded-full tooltip"
                                src="/dist/images/preview-4.jpg"
                                title="Uploaded at 15 January 2022"
                              />
                            </div>
                            <div className="w-10 h-10 -ml-5 image-fit zoom-in">
                              <img
                                ...
                                className="rounded-full tooltip"
                                src="/dist/images/preview-4.jpg"
                                title="Uploaded at 19 July 2022"
                              />
                            </div>
                            <div className="w-10 h-10 -ml-5 image-fit zoom-in">
                              <img
                                ...
                                className="rounded-full tooltip"
                                src="/dist/images/preview-2.jpg"
                                title="Uploaded at 17 January 2022"
                              />
                            </div>
                          </div>
                        </td>
                          ...
                          <div className="flex">
                            ...
                            <div className="w-10 h-10 -ml-5 image-fit zoom-in">
                              <img
                                ...
                                className="rounded-full tooltip"
                                src="/dist/images/preview-5.jpg"
                                title="Uploaded at 25 January 2021"
                              />
                            </div>
                          </div>
                        </td>
                ...
                <div className="flex flex-wrap items-center mt-3 intro-y sm:flex-row sm:flex-nowrap">
                  <ul className="pagination">
                    ...
                    <li>
                      <a className="pagination__link" href="">
                        {' '}
                        <i className="w-4 h-4" data-feather="chevron-left" />
                      </a>
                    </li>
                    <li>
                      <a className="pagination__link" href="">
              ...
              <div className="grid grid-cols-12 gap-6 2xl:pl-6">
                      ...
                      <div className="tiny-slider" id="important-notes">
                        <div className="p-5">
                          ...
                          <div className="flex mt-5 font-medium">
                            ...
                            <button
                              type="button"
                              className="px-2 py-1 ml-auto btn btn-outline-secondary"
                            >
                              Dismiss
                            </button>
                          </div>
                ...
                <div className="col-span-12 mt-3 md:col-span-6 xl:col-span-4 2xl:col-span-12">
                  ...
                  <div className="relative mt-5 report-timeline">
                      ...
                      <div className="flex-1 px-5 py-3 ml-4 box zoom-in">
                        ...
                        <div className="text-gray-600">
                          ...
                          <div className="flex mt-2">
                            <div
                              className="w-8 h-8 mr-1 tooltip image-fit zoom-in"
                              title="Sony A7 III"
                            >
                              <img
                                alt="Rubick Tailwind HTML Admin Template"
                    ...
                    <div className="my-4 text-xs text-center text-gray-500 intro-x">
                      12 November
                    </div>
                    <div className="relative flex items-center mb-3 intro-x">
                      <div className="report-timeline__image">
                ...
                <div className="col-span-12 mt-3 md:col-span-6 xl:col-span-4 2xl:col-span-12">
                  ...
                  <div className="mt-5">
                    ...
                    <a
                      href=""
                      className="block w-full py-3 text-center border border-dotted rounded-md intro-x border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600"
                    >
                      View More
                    </a>
                  </div>
                ...
                <div className="col-span-12 mt-3 md:col-span-6 xl:col-span-4 2xl:col-span-12">
                  <div className="flex items-center h-10 intro-x">
                    ...
                    <a
                      href=""
                      className="flex items-center ml-auto truncate text-theme-1 dark:text-theme-10"
                    >
                      {' '}
                      <i data-feather="plus" className="w-4 h-4 mr-1" /> Add New
                      Schedules{' '}
                    </a>
                  </div>
                  <div className="mt-5">
                    <div className="intro-x box">
                      <div className="p-5">
                        ...
                        <div className="grid grid-cols-7 gap-4 mt-5 text-center">
                          ...
                          <div className="py-0.5 rounded relative text-gray-600">
                            29
                          </div>
                          <div className="py-0.5 rounded relative text-gray-600">
                            30
