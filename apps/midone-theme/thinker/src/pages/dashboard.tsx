                ...
                <ul className="dropdown-content bg-primary text-white">
                  ...
                  <li>
                    <a href="" className="dropdown-item hover:bg-white/5">
                      {' '}
                      <i data-feather="user" className="w-4 h-4 mr-2"></i>{' '}
                      Profile{' '}
                    </a>
                  </li>
                  <li>
            ...
            <div className="col-span-12 2xl:col-span-9">
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 mt-6 -mb-6 intro-y">
                  <div
                    className="alert alert-dismissible show box bg-primary text-white flex items-center mb-6"
                    role="alert"
                  >
                    <span>
                ...
                <div className="col-span-12 lg:col-span-8 mt-6">
                  <div className="intro-y block sm:flex items-center h-10">
                    ...
                    <div className="sm:ml-auto mt-3 sm:mt-0 relative text-slate-500">
                      ...
                      <input
                        type="text"
                        className="form-control sm:w-40 box pl-10"
                            ...
                            <div className="flex">
                              <div className="w-10 h-10 image-fit zoom-in">
                                <img
                                  ...
                                  src="dist/images/preview-12.jpg"
                                  title="Uploaded at 17 July 2022"
                                />
                              </div>
                              ...
                              <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                <img
                                  ...
                                  title="Uploaded at 13 July 2021"
                                />
                              </div>
                            </div>
                          </td>
                            ...
                            <div className="flex">
                              <div className="w-10 h-10 image-fit zoom-in">
                                <img
                                  ...
                                  className="tooltip rounded-full"
                                  src="dist/images/preview-2.jpg"
                                  title="Uploaded at 5 September 2021"
                                />
                              </div>
                              <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                <img
                              ...
                              <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                <img
                                  ...
                                  title="Uploaded at 7 January 2022"
                                />
                              </div>
                            </div>
                          </td>
                            ...
                            <div className="flex">
                              ...
                              <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                <img
                                  ...
                                  title="Uploaded at 18 September 2022"
                                />
                              </div>
                            </div>
                          </td>
                ...
                <div className="2xl:pl-6 grid grid-cols-12 gap-6">
                  ...
                  <div className="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 xl:col-start-1 xl:row-start-2 2xl:col-start-auto 2xl:row-start-auto mt-3">
                    <div className="intro-x flex items-center h-10">
                      ...
                      >
                        {' '}
                        <i data-feather="plus" className="w-4 h-4 mr-1"></i> Add
                        New Schedules{' '}
                      </a>
                    </div>
                    <div className="mt-5">
