            ...
            return (
              <div key={index}>
                ...
                {proposalData?.Planos.filter(
                  ...
                  <div key={index}>
                    <common.TitleWithSubTitleAtTheTop
                      title={`${plan.Plano.Nome} | ${utils.BRLMoneyFormat(
                ...
                {proposalData?.Produtos.filter(
                  ...
                  <div key={index}>
                    <common.TitleWithSubTitleAtTheTop
                      title={`${product.Produto.Nome} | ${utils.BRLMoneyFormat(
                ...
                {proposalData?.Servicos.filter(
                  ...
                  <div key={index}>
                    <common.TitleWithSubTitleAtTheTop
                      title={`${service.Servico.Nome} | ${utils.BRLMoneyFormat(
                ...
                {proposalData?.Combos.filter(
                  ...
                  <div key={index}>
                    <common.TitleWithSubTitleAtTheTop
                      title={`${combo.Combo.Nome} | ${utils.BRLMoneyFormat(
                        getComboValue(combo)
                      )}`}
                      subtitle={`Combo`}
                    />
