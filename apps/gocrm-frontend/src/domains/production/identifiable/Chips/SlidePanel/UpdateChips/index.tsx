...
export default function Update() {
  ...
  const onSubmit = (formData: FormData) => {
    updateChip({
      variables: {
        ...
        NumeroDaLinha: utils.phoneUnformat(formData.Telefone)
      }
    })
      .then(() => {
        chipsRefetch()
        setSlidePanelState((oldState) => {
          ...
          utils.notification(formData.Telefone + ' editado com sucesso', 'success')
      })
      .catch((err) => {
        utils.showError(err)
      })
  ...
  useEffect(() => {
    reset({
      ...
      Telefone: utils.phoneFormat(slidePanelState.data?.NumeroDaLinha) || '',
      Operadora_Id: {
