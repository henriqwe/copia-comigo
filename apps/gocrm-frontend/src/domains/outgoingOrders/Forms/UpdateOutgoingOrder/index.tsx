...
const UpdateOutgoingOrder = () => {
  ...
  function loadDate() {
    if (outgoingOrderData?.DataRecebido) {
      setDate(utils.ptBRtimeStamp(outgoingOrderData?.DataRecebido as Date))
      return
    }
    if (outgoingOrderData?.DataEntregue) {
      setDate(utils.ptBRtimeStamp(outgoingOrderData?.DataEntregue as Date))
      return
    }
    if (outgoingOrderData?.DataAutorizacao) {
      setDate(utils.ptBRtimeStamp(outgoingOrderData?.DataAutorizacao as Date))
      return
    }

    setDate(utils.ptBRtimeStamp(outgoingOrderData?.DataAbertura as Date))
  }
