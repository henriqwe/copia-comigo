...
import { BRLMoneyFormat, BRLMoneyInputDefaultFormat } from '&test/utils/formaters'
...
const ViewVehicle = ({
  ...
  function getServicesDependencies(value: any, type: string) {
    ...
    switch (type) {
      case 'plans':
        return `Serviços inclusos: ${value.Plano ? value.Plano.Servico.Nome : value.Servico.Nome
          }`
