...
import * as purchaseOrder from '&test/components/domains/erp/purchases/PurchaseOrders'
import * as manufacturers from '&test/components/domains/erp/inventory/Registration/Manufacturers'
