...
import { GraphQLTypes, order_by } from '&test/graphql/generated/zeus'
import {
  $,
  useTypedClientQuery,
  useTypedMutation,
...
import { phoneUnformat } from '&test/utils/formaters'
...
type SellerContextProps = {
  ...
  getSelletById: (Id: string) => Promise<
    ...
    | undefined
  >
  sellerSchema: yup.AnyObjectSchema
  phoneSchema: yup.AnyObjectSchema
  emailsSchema: yup.AnyObjectSchema
}
