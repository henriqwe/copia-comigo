...
import Actions from '&test/components/common/MainMenu/Actions'
import Filters from '&test/components/common/MainMenu/Filters'
import Links from '&test/components/common/MainMenu/Links'
...
import Search from '&test/components/blocks/Table/Search'
