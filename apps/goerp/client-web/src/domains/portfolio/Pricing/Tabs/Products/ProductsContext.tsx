...
type ProductContextProps = {
  ...
  ItensTypeRefetch: () => void
  ItensTypeLoading: boolean
  activeProduct: (
  ...
  getProductProviderByProductId: (Id: string) => Promise<
    {
      ...
      Precos: {
        ...
        Valor: string
        created_at: Date
        TiposDeRecorrencia?: { Valor: string; Comentario: string }
...
export const ProductProvider = ({ children }: ProviderProps) => {
  ...
  const [
    ...
    {
      data: ItensTypeData,
      refetch: ItensTypeRefetch,
      loading: ItensTypeLoading
    }
  ] = useTypedLazyQuery(
    {
        ...
        },
        {
          ...
          Precos: [
            { order_by: [{ created_at: order_by.desc }] },
            {
              ...
              Valor: true,
              created_at: true,
              TiposDeRecorrencia: { Valor: true, Comentario: true },
  ...
  return (
    <ProductContext.Provider
      value={{
        ...
        linkItemSchema,
        runItemTypeQuery,
        ItensTypeData: ItensTypeData?.comercial_TipoDeItens,
        ItensTypeRefetch,
        ItensTypeLoading
      }}
    >
